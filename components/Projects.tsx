...
const Projects: React.FC = () => {
  const mainProjects = [
    ...
    {
      image: 'https://images.unsplash.com/photo-1555589519-e6d47a70e13b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80',
      width: 1170,
      height: 780,
      title: "Okapi Flow",
      description: "E-commerce premium de moda masculina com catálogo completo, integração com Mercado Pago, carrinho persistente e sistema de descontos progressivos.",
      tags: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Prisma', 'PostgreSQL'],
      liveUrl: 'https://okapi-flow.vercel.app',
      repoUrl: 'https://github.com/GEDEON1708/okapi-flow',
    },
    {
      ...
      height: 780,
      title: "RegulaOn",
      description: "Plataforma de regularização empresarial que oferece suporte humano + plataforma online para gerenciamento de licenças, AVCB e documentação.",
      tags: ['Next.js', 'React', 'Tailwind CSS', 'JavaScript'],
      liveUrl: 'https://regulaon.vercel.app',
      repoUrl: 'https://github.com/GEDEON1708/regulaOn',
    },
    {
      image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80',
      width: 1170,
      height: 780,
      title: "CGK Consultoria",
      description: "Website institucional com foco em clareza, credibilidade e captação de leads para serviços de consultoria.",
      tags: ['React', 'TypeScript', 'Tailwind CSS'],
      repoUrl: 'https://github.com/GEDEON1708/cgk-consultoria',
    },
  ];
